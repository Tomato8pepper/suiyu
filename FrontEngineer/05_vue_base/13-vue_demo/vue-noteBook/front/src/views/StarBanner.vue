<template>
  <div class="star-banner">
    <van-swipe class="my-swipe" :loop="true" @change="onChange">
      <van-swipe-item v-for="(item, index) in bannerList" :key="index">
          <div class="banner-img" :style="`background-image:url(${item.img})`">
          </div>
          <div class="title">{{item.title}}</div>
          <div class="desc">{{item.content}}</div>
      </van-swipe-item>
    </van-swipe>
    <div class="jump-over" @click="starLogin" >直接跳过</div>
  </div>
</template>
