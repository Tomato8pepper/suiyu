...
![1539262064299](./04-redux_dva/assets/1539262064299.png)
...
* 对组件进行连接
  ...
  * ![1531484827877](./04-redux_dva/assets/1531484827877.png)
...
![1539263420773](./04-redux_dva/assets/1539263420773.png)

#### 代码体验

- 1. dispatch接收action，接着reducer根据action.type处理state
  2. connect提供组建内dispatch和获取state的便捷方式
     1. ![1532520954445](./04-redux_dva/assets/1532520954445.png)
     2. ![1532520965147](./04-redux_dva/assets/1532520965147.png)
  3. 异步请求需要中间件action__下面的dispatch可以想象为 dispatch(...action);__
     1. ![1532520946449](./04-redux_dva/assets/1532520946449.png)
  4. combineReducers用来合并reducer
- 对象关系
  - ![1532518892891](./04-redux_dva/assets/1532518892891.png)
...
* 使用
* action中的异步行为
* ![1538031300872](./04-redux_dva/assets/1538031300872.png)
...
![1539264901840](./04-redux_dva/assets/1539264901840.png)
...
![20180228144907855](./04-redux_dva/assets/20180228144907855.jpg)
...
![1539268195207](./04-redux_dva/assets/1539268195207.png)
