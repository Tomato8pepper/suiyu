<template>
  <div>
    ...
    <div class="photo-title">
      ...
      <span
        >发起日期：{{
          photoInfo.add_time | converTime("YYYY年MM月DD日")
        }}</span >
  ...
  data() {
    return {
      photoInfo: {
          ...
          click: 3,
          add_time: '2020-04-18T04:59: 13.00Z',
          content: '放假啊路口见佛if瑟吉欧建瓯市恩安居佛诶见哦色戒覅偶尔加萨佛界寺佛奥SEI金佛IE司法解释诶哦角色哦就否瑟菌费二十几哦if角色哦啊见佛色骄傲佛结算价藕节'
      }, //图文详情
      imgs: [
        {
          src:
            "https://scpic2.chinaz.net/Files/pic/pic9/202011/hpic3155_s.jpg",
          msrc:
            "https://scpic2.chinaz.net/Files/pic/pic9/202011/hpic3155_s.jpg",
          alt: "picture1",
